<template>
  <div class="content-user" id="ctt-user">
    <Head></Head>
    <div class="DLYM-user">
      <div class="content1">
        <p class="title-1">用户协议</p>
        <div class="conts">
          <div class="centent_1">
            <div>
              Huobi Global Limited.（以下称
              “公司”）是一家根据塞舌尔共和国相关法律在塞舌尔共和国注册成立的公司，该公司运营网站https://www.huobi.vc（以下称“本网站”或“网站”），该网站是一个专门供用户进行数字资产交易和提供相关服务（以下称“该服务”或“服务”）的平台。为了本协议表述之方便，公司和该网站在本协议中合称使用“我们”或其他第一人称称呼。只要登陆该网站的自然人或其他主体均为本网站的用户，本协议表述之便利，以下使用“您”或其他第二人称。为了本协议表述之便利，我们和您在本协议中合称为“双方”，我们或您单称为“一方”。本网站所有内容，为便利用户，可能提供多个语言版本，若有冲突或遗漏等情况，以中文内容为准。
            </div>
            <p>重要提示：</p>
            <p>我们在此特别提醒您：</p>
            <ul>
            ...
            <ul>
              ...
              <li>
                5 https://www.huobi.vc为本网站唯一官方对外信息公布平台；
              </li>
              <li>
                6
            ...
            <ul>
              ...
              <li>
                1.5
                只有成为本网站的会员才可使用本网站提供的数字资产交易平台进行交易及享受其他本网站规定的只有会员才可获得的服务；非会员只有登陆网站、浏览网站及其他本网站规定的可获得的服务。
              </li>
              <li>
                1.6
                ...
                <ul class="indent">
                  ...
                  <li>
                    1.6.3
                    您保证交易中涉及到的属于您的数字资产均为合法取得并享有所有权。
                  </li>
                  <li>
                    1.6.4
            ...
            <ul>
              <li>
                ...
                <ul class="indent">
                  ...
                  <li>
                    4.1.2
                    您有权在本网站查看您会员账号下的信息，有权应用本网站提供的功能进行操作。
                  </li>
                  <li>
                    4.1.3
                    您有权按照本网站发布的活动规则参与本网站组织的网站活动。
                  </li>
              ...
              <li>
                ...
                <ul class="indent">
                  <li>
                    4.2.1
                    您应当遵守法律法规、规章、及政策要求的规定，保证账户中所有数字资产来源的合法性，不得在本网站或利用本网站服务从事非法或其他损害本网站或第三方权益的活动，包括但不限于发送或接收任何违法、违规、侵犯他人权益的信息，发送或接收传销材料或存在其他危害的信息或言论，未经本网站授权使用或伪造本网站电子邮件题头信息等。
                  </li>
                  <li>
                    4.2.2
                    您应当遵守法律法规并妥善使用和保管您的账号及登陆密码、资金密码、和您注册时绑定的手机号码、以及手机接收的手机验证码。您对使用您的账号和登陆密码、资金密码、手机验证码进行的任何操作和后果承担全部责任。当您发现本网站账号、登陆密码、或资金密码、验证码被未经您授权的第三方使用，或存在其他账号安全问题时，应立即有效通知本网站，要求本网站暂停本网站账号的服务。本网站有权在合理时间内对您的该等请求采取行动，但本网站对在采取行动前已经产生的后果（包括但不限于您的任何损失）不承担任何责任。您在未经本网站同意的情况下不得将本网站账号以赠与、借用、租用、转让或其他方式处分给他人。
                  </li>
                  <li>
                    4.2.3
                    您同意对您的本网站的账号、密码下发生的所有活动（包括但不限于信息披露、发布信息、网上点击同意或提交各类规则协议、网上续签协议或购买服务等）承担责任。
                  </li>
                  <li>
                    4.2.4
            ...
            <ul>
              ...
              <li>
                5.2
                根据本网站自己的判断，本网站发现您或您的关联账户使用者不适合高风险投资时，有权中止或终止您的账户以及所有关联账户的使用。
              </li>
              <li>
                5.3
              ...
              <li>
                5.7
                本网站将采取必要的技术手段和管理措施保障本网站的正常运行，并提供必要、可靠的交易环境和交易服务，维护数字资产交易秩序。
              </li>
              <li>
                5.8
                如您连续一年未使用本网站会员账号和密码登陆本网站，则本网站有权注销您的本网站账号。账号注销后，本网站有权将相应的会员名开放给其他用户注册使用。
              </li>
              <li>
                5.9
                本网站通过加强技术投入、提升安全防范等措施保障您的数字资产的安全，并将在您账户出现可以预见的安全风险时提前通知您。
              </li>
              <li>
                5.10
            ...
            <ul>
              <li>
                6.1
                在任何情况下，我们对您的直接损害的赔偿责任均不会超过我们因您使用本网站为期三（
                3）个月服务而向您收取的总服务费。
              </li>
              <li>
                6.2
            ...
            <ul>
              <li>
                ...
                <ul class="indent">
                  ...
                  <li>8.1.3 业务中断造成的损失</li>
                  <li>8.1.4 预期可节省的货币的损失；</li>
                  <li>8.1.5 信息问题造成的损失；</li>
              ...
              <li>
                ...
                <ul class="indent">
                  <li>8.2.1 您的具体交易事项可能存在重大违法或违约情形。</li>
                  <li>8.2.2 您在本网站的行为涉嫌违法或不道德。</li>
                  <li>
                    8.2.3
            ...
            <ul>
              ...
              <li>9.3 本协议的终止不影响守约方向违约方要求承担其他责任。</li>
            </ul>
            ...
            <ul>
              ...
              <li>
                10.3
                您接受本协议即视为您主动将您在本网站发表的任何形式的信息的著作权，
            ...
            <p>
              本协议全部内容均为根据塞舌尔共和国法律而订立，其成立、解释、内容及执行均适用塞舌尔共和国相关法律规定；任何因与本协议约定的服务有关而产生的索赔或诉讼，都应依照塞舌尔共和国的法律进行管辖并加以解释和执行。
              为避免疑义，这一条款明确适用于任何针对我们的侵权索赔。任何针对我们或者和我们有关的索赔或诉讼的管辖法院或诉讼地均在塞舌尔共和国。您无条件地获得在塞舌尔共和国法院进行诉讼和上诉的排他性的管辖权。您也无条件地同意与本协议有关的争议或问题或产生的任何索赔请求和诉讼的发生地或法院均排他性地在塞舌尔共和国，如有本网站其他业务对管辖有专门约定的，从其约定。不方便法院的原则不适用于根据本服务条款选择的法院。
            </p>
            ...
            <div>了解你的客户和反洗钱政策</div>
            <em class="paragraph">一、导言</em>
            <ul>
              <li>
